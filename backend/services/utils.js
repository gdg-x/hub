...
const MonthlyMetric = mongoose.model('MonthlyMetric')
const moment = require('moment')
const forge = require('node-forge')

exports.base64urlDecode = function base64urlDecode (str) {
  return new Buffer(this.base64urlUnescape(str), 'base64').toString()
}

exports.base64urlUnescape = function base64urlUnescape (str) {
