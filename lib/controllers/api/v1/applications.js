...
module.exports = function (app) {
  ...
  app.route('post', '/applications', middleware.auth(), function (req, res) {
  ...
  app.route('get', '/applications', middleware.auth(), function (req, res) {
    utils.getModel('Application', {
      user: req.user._id
    })(req, res);
  });

  app.route('get', '/applications/:applicationId', middleware.auth(), function (req, res) {
  ...
  app.route('delete', '/applications/:applicationId', middleware.auth(), function (req, res) {
  ...
  app.route('post', '/applications/:applicationId/simpleapikeys', middleware.auth(), function (req, res) {
  ...
  app.route('get', '/applications/:applicationId/simpleapikeys', middleware.auth(), function (req, res) {
  ...
  app.route('get', '/applications/:applicationId/consumers', middleware.auth(), function (req, res) {
  ...
  app.route('post', '/applications/:applicationId/consumers', middleware.auth(), function (req, res) {
