...
module.exports = function(app) {
	...
	app.route("get", "/events/stats", {}, function(req, res) {
		async.parallel([
		    function(callback){
		    	// Count Tags
		    	Event.aggregate([
	...
	app.route("get", "/events/:eventId", {}, utils.getModel('Event', {
		_id: "eventId"
	}));

	app.route("get", "/events/tag/:tag", {}, utils.getModel('Event', {
		tags: "tag"
	}));

	app.route("get", "/chapter/:chapterId/events", {}, utils.getModel('Event', {
		chapter: "chapterId",
		end: { "$gt": new Date() }
	}));

	app.route("get", "/chapter/:chapterId/events/past", {}, utils.getModel('Event', {
		chapter: "chapterId",
		end: { "$lt": new Date() }
	}));

	app.route("get", "/chapter/:chapterId/events/tag/:tag", {}, utils.getModel('Event', {
		chapter: "chapterId",
		tags: "tag"
	}));

	app.route("get", "/chapter/:chapterId/events/stats", {}, function(req, res) {
